...
<ul style="font-size: 14px; line-height: 1.8; color: #444; margin: 10px 0;">
  ...
  <li><strong>Мобильная консоль администрирования APP</strong>: Кроссплатформенная мобильная консоль на базе uni-app 3, один код компилируется в H5, мини-программу WeChat и нативное App. Использует тот же backend API (<code>/admin-api</code>), что и PC-клиент (WEB), позволяя операционным и управленческим сотрудникам контролировать платформу в любое время и в любом месте. Основные вкладки: <strong>Устройства</strong> (единый список и просмотр каналов для прямых камер, GB28181 и NVR; предпросмотр в реальном времени в один клик), <strong>Ретрансляция потоков</strong> (создание задач, запуск/остановка, статус узлов кластера и просмотр URL нескольких потоков), <strong>Алгоритмы</strong> (список задач в реальном времени/снимков, управление запуском/остановкой и статистика детекции), <strong>Тревоги</strong> (поиск тревог, предпросмотр снимков и VOD-воспроизведение записей тревог), <strong>Модели</strong> (список и статус развёртывания), <strong>Инференс</strong> (мобильная рабочая станция: выбор модели, загрузка изображения, просмотр результатов), <strong>Обучение</strong> (мониторинг прогресса и остановка в один клик), <strong>Профиль</strong> (личные данные, безопасность аккаунта, переключение арендаторов и настройки). H5 интегрирует плеер Jessibuca с низкой задержкой для FLV/HLS и VOD записей тревог; OAuth2 с двумя токенами и персистентность Pinia обеспечивают автоматическое продление сессии — интеллектуальное управление облако-граница-устройство на телефонах и в мини-программах</li>
</ul>
...
<p style="font-size: 14px; line-height: 1.8; color: #555; margin: 15px 0;">
EasyAIoT на самом деле не один проект, а семь проектов.
</p>
...
<p style="font-size: 15px; line-height: 1.8; color: #333; margin: 15px 0;">
EasyAIoT состоит из семи основных проектов:
</p>
...
<td style="padding: 15px; border: 1px solid #e0e0e0; line-height: 1.8; color: #444;">
  <ul style="margin: 5px 0; padding-left: 20px;">
    <li><strong>Кроссплатформенный фреймворк</strong>: uni-app 3 + Vue 3 + TypeScript + Vite; один код для H5, мини-программы WeChat и нативного App</li>
    <li><strong>Повторное использование API</strong>: Общий backend <code>/admin-api</code> с WEB-модулем; OAuth2 с двумя токенами, переключение арендаторов</li>
    <li><strong>Управление устройствами</strong>: Единый список прямых камер, GB28181 и NVR; статус онлайн и просмотр каналов; предпросмотр в деталях (H5 с плеером Jessibuca)</li>
...
<p style="font-size: 14px; line-height: 1.8; color: #2c3e50; font-weight: 500; margin: 20px 0; padding: 15px; background-color: #e8f4f8; border-left: 4px solid #3498db; border-radius: 4px;">
<strong>Особая благодарность</strong>: Работа перечисленных участников способствовала развитию EasyAIoT в разных направлениях — от документации и сценариев кроссплатформенного развертывания до внедрения видеовозможностей по национальному стандарту (включая GB28181), интеграционного тестирования с ИИ, прямого обнаружения многобрендовых камер и массового подключения, полноценной реализации пространственной визуализации Tianditu, архитектуры развёртывания и планирования гетерогенных потоковых кластеров, полноценной реализации алгоритма распознавания номеров и программного кода, сквозной интеграции EasyAIoT-Edge на периферии, а также организации кампусного сообщества разработчиков и построения экосистемы молодёжного сотрудничества. Их профессионализм и самоотверженная преданность достойны нашего изучения и уважения. Ещё раз выражаем нашу самую искреннюю благодарность этим выдающимся участникам! 🙏
</p>
